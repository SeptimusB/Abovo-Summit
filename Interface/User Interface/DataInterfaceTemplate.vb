...
#Region "Menu Button Actions"
    ...
    Public Function GetExportCandidates() As List(Of DITExportCandidate)
        ...
        'the point at which the user asks to see every available section.
        For sectionIndex As Integer = 0 To XtraTabControlNewGIT.TabPages.Count - 1
        ...
        For Each page As XtraTabPage In XtraTabControlNewGIT.TabPages
            ...
            For controlIndex As Integer = 0 To printableControls.Count - 1
                Dim printable As DevExpress.XtraPrinting.IPrintable =
                    TryCast(printableControls(controlIndex), DevExpress.XtraPrinting.IPrintable)
                If printable Is Nothing Then Continue For

                Dim sectionName As String = page.Text.Trim()
                Dim title As String = DITName
                If sectionName.Length > 0 Then title &= " - " & sectionName
                If printableControls.Count > 1 Then
