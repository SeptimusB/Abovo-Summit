...
The 2q whole-model run bound Funding in 42.2 seconds. Narrowing effective-format prefetch from eight rows/four columns to eight rows/one column measured 39.5 seconds in the first 2s run, but Covenant also varied and this is not a controlled median or a proved improvement. Native fills and protection still come from Excel DisplayFormat; none are inferred from colours or stale DevExpress caches. The 2s full lifecycle repeat is pending at this checkpoint.
